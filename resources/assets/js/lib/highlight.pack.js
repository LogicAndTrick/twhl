...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
contains:[e.UNDERSCORE_TITLE_MODE]},{begin:"=>"},l,s]}}}());hljs.registerLanguage("dos",function(){"use strict";return function(e){
...
className:"number",begin:"\\b\\d+",relevance:0},t]}}}());hljs.registerLanguage("angelscript",function(){"use strict";return function(e){
var n={className:"built_in",
...
illegal:"(^using\\s+[A-Za-z0-9_\\.]+;$|\\bfunctions*[^\\(])",contains:[{
...
begin:"\\b(null|true|false)"},{className:"number",
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}}());hljs.registerLanguage("ini",function(){"use strict";function e(e){
...
starts:{end:/$/,contains:[i,c,r,t,l,s]}}]}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
;return n.name="C",n.aliases=["c","h"],n}}());hljs.registerLanguage("plaintext",function(){"use strict";return function(t){
return{name:"Plain text",aliases:["text","txt"],disableAutodetect:!0}}}());hljs.registerLanguage("cpp",function(){"use strict";return function(e){
