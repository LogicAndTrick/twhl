<div class="btn-toolbar wiki-navigation">
    @if (isset($revision) && $revision)
        <div class="btn-group" role="group">
            <a class="btn btn-secondary title-button" href="{{ act('wiki', 'page', $revision->slug) }}">{{ $revision->getNiceTitle() }}</a>
            @if (permission('WikiCreate') && $revision->wiki_object->canEdit())
                <a class="btn btn-secondary" href="{{ act('wiki', 'edit', $revision->slug) }}"><span class="fa fa-pencil"></span> Edit</a>
            @endif
    ...
    @if (permission('ForumCreate'))
        <div class="btn-group" role="group">
            <a class="btn btn-secondary" href="{{ act('wiki', 'create') }}"><span class="fa fa-plus"></span> Create a new page</a>
            <a class="btn btn-secondary" href="{{ act('wiki', 'create-upload') }}"><span class="fa fa-arrow-up"></span> Upload a new file</a>
        </div>
    @endif
    <div class="btn-group" role="group">
        <a class="btn btn-secondary" href="{{ act('wiki', 'pages') }}">See all pages</a>
        <a class="btn btn-secondary" href="{{ act('wiki', 'uploads') }}">See all uploads</a>
        <a class="btn btn-secondary" href="{{ act('wiki', 'categories') }}">See all categories</a>
    </div>
</div>