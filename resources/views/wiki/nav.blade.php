    ...
    @if (isset($revision) && $revision)
        <div class="btn-group" role="group">
            ...
            @if (permission('WikiCreate') && $revision->wiki_object->canEdit())
                <a class="btn btn-default" href="{{ act('wiki', 'edit', $revision->slug) }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
            @endif
            <a class="btn btn-default" href="{{ act('wiki', 'history', $revision->slug) }}"><span class="glyphicon glyphicon-time"></span> History</a>
        </div>
    @elseif (isset($cat_name) && $cat_name != null)
        <div class="btn-group" role="group">
            ...
            @if (permission('WikiCreate'))
                <a class="btn btn-default" href="{{ act('wiki', 'create', 'category:'.$cat_name) }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
            @endif
        </div>
    @endif
    @if (permission('ForumCreate'))
        <div class="btn-group" role="group">
            <a class="btn btn-default" href="{{ act('wiki', 'create') }}"><span class="glyphicon glyphicon-plus"></span> Create a new page</a>
            <a class="btn btn-default" href="{{ act('wiki', 'create-upload') }}"><span class="glyphicon glyphicon-arrow-up"></span> Upload a new file</a>
        </div>
    @endif
    <div class="btn-group" role="group">
