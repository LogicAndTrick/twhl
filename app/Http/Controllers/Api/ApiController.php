...
class ApiController extends Controller {
    ...
    private function post_image_upload() {
        ...
        // Force lossy compression if the image is more than 1MiB or if we know it was lossily compressed before
        $force_lossy_compression = false;
        if ($image->getSize() >= 1024 * 1024 || $image->getClientOriginalName() === 'lossily-recompressed') {
